...
const UsaPage = () => {
      ...
      <div className="hero-content">
        ...
        <div className="text-section">
          ...
          <p className="hero-description">
            Studying in the USA might be closer than you think. Many international students, including those from India, choose the US each year for its opportunities.
          </p>
        ...
        <div className="image-section">
          <img
            src="https://ik.imagekit.io/onsnhxjshmp/USA_Hero_Desktop_5247fe80a1.png"
            alt="university"
  ...
  <div className="highlights-grid">
    {[
      { title: "Indian Students in USA", value: "2.5L+" },
  ...
  <h2 className="why-study-title">Why Study in USA?</h2>
    ...
    {[
      {
        ...
        text: "The USA is home to some of the world’s best universities, offering you cutting-edge programmes and a chance to learn from renowned professors."
      },
      {
      ...
      },
      {
        ...
        title: "High ROI",
        text: "A degree from the USA opens doors to global career opportunities, making it a worthwhile investment in your future."
      }
    ].map((item, index) => (
