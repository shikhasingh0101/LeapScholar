...
const CanadaPage = () => {
      ...
      <div className="hero-content">
        ...
        <div className="text-section">
          ...
          <p className="hero-description">
            Studying in the Canada might be closer than you think. Many international students, including those from India, choose the US each year for its opportunities.
          </p>
        ...
        <div className="image-section">
          <img
            src="https://ik.imagekit.io/onsnhxjshmp/Desktop_1ed91b20f2.png"
            alt="university"
  ...
  <p className="highlights-description">
    Here are the key details related to studying in Canada
  </p>
  <div className="highlights-grid">
    {[
      { title: "Indian Students in Canada", value: "2.5L+" },
  ...
  <h2 className="why-study-title">Why Study in Canada?</h2>
    ...
    {[
      {
        ...
        text: "The Canada is home to some of the world’s best universities, offering you cutting-edge programmes and a chance to learn from renowned professors."
      },
      {
      ...
      },
      {
        ...
        title: "High ROI",
        text: "A degree from the Canada opens doors to global career opportunities, making it a worthwhile investment in your future."
      }
    ].map((item, index) => (
  ...
  <div className="image-section">
          <img
            src="https://ik.imagekit.io/onsnhxjshmp/Counselling_Banner_fb2746b54c.png"
            alt="university"
