...
const GermanyPage = () => {
      ...
      <div className="hero-content">
        ...
        <div className="text-section">
          ...
          <p className="hero-description">
            Studying in the Germany might be closer than you think. Many international students, including those from India, choose the US each year for its opportunities.
          </p>
        ...
        <div className="image-section">
          <img
            src="https://ik.imagekit.io/onsnhxjshmp/Germany_Hero_Desktop_59bda5b0cf.png"
            alt="university"
  ...
  <div className="highlights-grid">
    {[
      { title: "Indian Students in Germany", value: "2.5L+" },
  ...
  <h2 className="why-study-title">Why Study in Germany?</h2>
    ...
    {[
      {
        ...
        text: "The Germany is home to some of the world’s best universities, offering you cutting-edge programmes and a chance to learn from renowned professors."
      },
      {
      ...
      },
      {
        ...
        title: "High ROI",
        text: "A degree from the Germany opens doors to global career opportunities, making it a worthwhile investment in your future."
      }
    ].map((item, index) => (
  ...
  <div className="image-section">
          <img
            src="https://ik.imagekit.io/onsnhxjshmp/Germany_ece130ce87.png"
            alt="university"
