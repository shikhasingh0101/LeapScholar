...
const IrelandPage = () => {
      ...
      <div className="hero-content">
        ...
        <div className="text-section">
          ...
          <p className="hero-description">
            Studying in the Ireland might be closer than you think. Many international students, including those from India, choose the US each year for its opportunities.
          </p>
        ...
        <div className="image-section">
          <img
            src="https://ik.imagekit.io/onsnhxjshmp/Ireland_Hero_Desktop_ef7cc2d928.png"
            alt="university"
  ...
  <div className="highlights-grid">
    {[
      { title: "Indian Students in Ireland", value: "2.5L+" },
  ...
  <h2 className="why-study-title">Why Study in Ireland?</h2>
    ...
    {[
      {
        ...
        text: "The Ireland is home to some of the world’s best universities, offering you cutting-edge programmes and a chance to learn from renowned professors."
      },
      {
      ...
      },
      {
        ...
        title: "High ROI",
        text: "A degree from the Ireland opens doors to global career opportunities, making it a worthwhile investment in your future."
      }
    ].map((item, index) => (
  ...
  <div className="image-section">
          <img
            src="https://ik.imagekit.io/onsnhxjshmp/Ireland_aa9cd6785c.png"
            alt="university"
