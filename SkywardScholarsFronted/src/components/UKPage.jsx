...
const UKPage = () => {
      ...
      <div className="hero-content">
        ...
        <div className="text-section">
          ...
          <p className="hero-description">
            Studying in the UK might be closer than you think. Many international students, including those from India, choose the US each year for its opportunities.
          </p>
        ...
        <div className="image-section">
          <img
            src="https://ik.imagekit.io/onsnhxjshmp/UK_Hero_Desktop_f66539e5de.png"
            alt="university"
  ...
  <p className="highlights-description">
    Here are the key details related to studying in UK
  </p>
  <div className="highlights-grid">
    {[
      { title: "Indian Students in UK", value: "2.5L+" },
  ...
  <h2 className="why-study-title">Why Study in UK?</h2>
    ...
    {[
      {
        ...
        text: "The UK is home to some of the world’s best universities, offering you cutting-edge programmes and a chance to learn from renowned professors."
      },
      {
      ...
      },
      {
        ...
        title: "High ROI",
        text: "A degree from the UK opens doors to global career opportunities, making it a worthwhile investment in your future."
      }
    ].map((item, index) => (
  ...
  <div className="image-section">
          <img
            src=" https://ik.imagekit.io/onsnhxjshmp/USA_Banner_Desktop_40af1e1552.png"
            alt="university"
